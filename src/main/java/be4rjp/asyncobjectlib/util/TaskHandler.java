...
public class TaskHandler{
    ...
    public static <U> CompletableFuture<U> supplySync(Supplier<U> supplier){
        ...
        new BukkitTaskHandler<>(completableFuture, supplier, false).runTask(AsyncObjectLib.getPlugin());
    ...
    public static <U> CompletableFuture<U> supplyAsync(Supplier<U> supplier){
        CompletableFuture<U> completableFuture = new CompletableFuture<>();
        new BukkitTaskHandler<>(completableFuture, supplier, true).runTaskAsynchronously(AsyncObjectLib.getPlugin());
    ...
    public static <U> CompletableFuture<U> supplyWorldSync(World world, Supplier<U> supplier){
        CompletableFuture<U> completableFuture = new CompletableFuture<>();
        new WorldTaskHandler<>(completableFuture, supplier, world).runTask(AsyncObjectLib.getPlugin());
        
        return completableFuture;
    }
    
    public static void runSync(Runnable runnable){
        Bukkit.getScheduler().runTask(AsyncObjectLib.getPlugin(), runnable);
    }
    
    public static void runAsync(Runnable runnable){
        Bukkit.getScheduler().runTaskAsynchronously(AsyncObjectLib.getPlugin(), runnable);
    }
    ...
    public static void runWorldSync(World world, Runnable runnable){
        ...
        }.runTask(AsyncObjectLib.getPlugin());
    }
